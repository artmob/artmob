/* $Id: weblinks.admin.js,v 1.1.2.1 2008/08/31 18:16:11 rmiddle Exp $ */
...
function weblinks_setup() {
  ...
  $("#weblinks-view-settings").addClass('collapsed').animating = false;
  $("#weblinks-link-settings").addClass('collapsed').animating = false;
  $("#weblinks-group-settings").addClass('collapsed').animating = false;
  $("#weblinks-page-settings").addClass('collapsed').animating = false;
}
